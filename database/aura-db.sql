...
INSERT INTO events (id, name, description, photo, city, venue, adress, organization_id, start_date, end_date) VALUES
    ...
    'ornatos-violeta.jpg', 'Porto', 'Estádio do Dragão', 'Estádio do Dragão - Via Futebol Clube do Porto, 4350-415 Porto', 8, '2024-12-14 21:00:00', '2024-12-14 23:00:00'),
    ...
    'super-rock-super-bock.png', 'Lisboa', 'Parque das Nações',  'Parque das Nações - 1990-231 Lisboa',9, '2024-08-14 21:00:00', '2024-08-18 21:00:00'),
