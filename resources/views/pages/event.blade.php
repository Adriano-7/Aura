                            ...
                            <div class="votes-row">
                                @if(Auth::check() && !Auth::user()->is_admin && Auth::user()->id != $comment->author->id && Auth::user()->participatesInEvent($event))
                                    ...
                                    @if($comment->userVote(Auth::user()->id) == 1)
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-arrow-down-circle D1" viewBox="0 0 16 16" style="cursor: pointer; margin-right:0.5em" id="{{'downIcon-' . $comment->id}}">
                                            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                                        </svg>
                                    @endif
                                    @if($comment->userVote(Auth::user()->id) == -1)
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-arrow-up-circle L-1" viewBox="0 0 16 16" style="cursor: pointer; margin-right:0.5em" id="{{'upIcon-' . $comment->id}}">
                                            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707z"/>
                                        </svg>
